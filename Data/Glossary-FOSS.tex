...
\newglossaryentry{DSC}{name={Debian Social Contract},
  description={``Debian Social Contract'' refers to the Debian
    developers' commitment towards the \gls{FS} community. The Debian
    ...
    into the
    \gls{OSD}.\footnote{\url{https://www.debian.org/social_contract}} }
}

\newdualentry{DRM}{DRM}{Digital Rights Management}{ A collection of
...
\newglossaryentry{peer review}{name={peer review}, description={In
...
\newglossaryentry{reciprocal}{name={reciprocal public license},
...
\newdualentry{DMCA}{DMCA}{Digital Millennium Copyright Act}{ The
  ...
  copyrighted works (commonly known as \gls{DRM}). It also
...
\newglossaryentry{copyleft}{name={copyleft}, description={ A general method for
...
\newglossaryentry{CSS}{name={Content Scramble System}, description={An
    early \Gls{DRM} scheme designed for the protection of the contents
...
\newglossaryentry{impodispossess}{name={impossible to dispossess},
...
\newglossaryentry{contribuagree}{name={contribution agreement}, description={In the
    \Gls{FOSS} context, it is a legal document that specifies the conditions for transferring
...
\newglossaryentry{BDFL}{name={BDFL}, description={Short for Benevolent
...
\newglossaryentry{Modularity}{name=Modularity, description={Modularity
...
\newglossaryentry{Granularity}{name=Granularity,
...
\newglossaryentry{joint copyright}{name={joint copyright},
...
\newglossaryentry{software-stack}{name={Software Stack},
...
\newglossaryentry{opencore}{name={Open Core}, description={ The
