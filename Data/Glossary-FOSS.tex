...
\newglossaryentry{reciprocal}{name={reciprocal public license}, description={The
    Reciprocal Public License is a copyleft software license. This License is
...
\newdualentry{DMCA}{DMCA}{Digital Millennium Copyright Act}{
    The Digital Millennium Copyright Act is a 1998 United States copyright law
    that implements two 1996 treaties of the \acrfull{WIPO}. It criminalizes
    production and dissemination of technology, devices, or services intended to
    circumvent measures that control access to copyrighted works (commonly known as
    \gls{DRM}). It also criminalizes the act of circumventing an access control,
    ...
    Passed on October 12, 1998, by a unanimous vote in the United States Senate and
    signed into law by President Bill Clinton on October 28, 1998, the DMCA amended
    Title 17 of the United States Code to extend the reach of copyright, while
    limiting the liability of the providers of online services for copyright
    infringement by their users. \cite{dmca-wiki, dmca-overview}}
...
\newglossaryentry{impodispossess}{name={impossible to dispossess}, description={In the
    context of intellectual property, after an idea or knowledge is transferred, it is
    impossible that the receiver dispossess it and that the process of knowledge transfer
    is reversed\cite{digirightmana}} }
...
\newglossaryentry{joint copyright}{name={joint copyright}, description={ Joint copyright
    is when two or more individuals contribute to the work and share afterwards the copyright
    with each other. These individuals can sue for non-violation and damages. If a license
    change is wanted an agreement of all these holders is required} }
