...
\newglossaryentry{software-stack}{name={Software Stack}, description={A software stack can have the following meanings \cite{technopedia-ss, wiki-stack}: 
    \begin{itemize}
        \item A group of programs that work together to produce a result or achieve a common goal. 
        \item Any set of applications that works in a specific and defined order toward a common goal. For example for the Linux-based software stack is LAMP (Linux, Apache, MYSQL, Perl or PHP or Python) for developing web services.
        \item The set of applications or programming languages used by team to developed solutions/projects
    \end{itemize}
} }

\newglossaryentry{opencore}{name={Open Core}, description={
    The open-core model is a business model for the monetization of commercially-produced open-source software. It involves primarily offering a "core" or feature-limited version of a software product as free and open-source software, while offering "commercial" versions or add-ons as proprietary software.\cite{wiki-opencore}} }
