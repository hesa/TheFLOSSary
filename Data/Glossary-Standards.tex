...
\newacronym{fsry:SWOT}{SWOT}{strengths, weaknesses, opportunities and threats}
...
\newacronym{fsry:EPC}{EPC}{European Patent Convention}
\newacronym{fsry:CII}{CII}{computer implemented inventions}
...
\dualfsryentry{SEP}{SEP}{standards essential patent}{A standards
...
\newglossaryentry{fsry:interop} { name = {interoperability}, description = {
    ...
    applications, or components''\cite{fsry:gasser-palfrey-2007} } }
